...
SOCKET_FILE="$PROJECT_DIR/vanna_hr.sock"
SERVICE_NAME="vanna_hr"
GUNICORN_MODULE="dev.poc_vanna_hr:app"
...
ExecStart=$VENV_DIR/bin/gunicorn --workers 3 --bind unix:$SOCKET_FILE $GUNICORN_MODULE --access-logfile $PROJECT_DIR/models/hr/access.log --error-logfile $PROJECT_DIR/models/hr/error.log
...
sudo chown www-data:www-data /home/ubuntu/poc_vanna_odoo/${SERVICE_NAME}.sock
sudo chmod 660 /home/ubuntu/poc_vanna_odoo/vanna.sock

# show nginx logs
sudo tail -n 50 /var/log/nginx/error.log

curl --unix-socket /home/ubuntu/poc_vanna_odoo/vanna_hr.sock http://localhost/models
